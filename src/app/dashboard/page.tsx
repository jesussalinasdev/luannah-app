  ...
  return (
    <div className="animate-fade-in flex flex-col gap-8">
      ...
      <div className="glass-panel p-8">
        <h3 className="text-xl font-bold text-[var(--color-accent-teal)] mb-4">About Me</h3>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Link href="/dashboard/podcast" className="glass-panel p-6 text-center hover:bg-white/90 transition-colors group">
          <h4 className="font-bold text-gray-800 mb-1 group-hover:text-[var(--color-accent-blue)]">Latest Podcast</h4>
        ...
        <Link href="/dashboard/shop" className="glass-panel p-6 text-center hover:bg-white/90 transition-colors group">
          <h4 className="font-bold text-gray-800 mb-1 group-hover:text-[var(--color-accent-blue)]">New Arrivals</h4>
